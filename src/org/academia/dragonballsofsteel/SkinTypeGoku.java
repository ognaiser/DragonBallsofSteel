...
public enum SkinTypeGoku {
    ...
    GokuGroundLeft("Resources/goku/goku_start_esquerda.png"),
    GokuGroundRight("Resources/goku/goku_start_direita.png"),
    GokuDefLeft("Resources/goku/goku_defende_2_esquerda.png"),
    GokuDefRight("Resources/goku/goku_defende_2_direita.png"),
    GokuFlyLeft("Resources/goku/goku_voar_frente_esquerda.png"),
    GokuFlyRight("Resources/goku/goku_voar_frente_direita.png"),
